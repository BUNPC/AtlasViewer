...
# If not running setup script from ~/Downloads/atlasviewer_install then 
# copy current atlasviewer_install folder to ~/Downloads  
print hOutput "currpath=\$(dirname \"\$0\")\n";
print hOutput "exe_dir=~/Downloads/atlasviewer_install\n";
