...
print hOutput "err=0;\n";
print hOutput "if [ \"\$script_dir\" = \"\$HOME/Downloads/atlasviewer_install\" ]; then\n";
print hOutput "    echo \"Installation folder is correct...\"\n";
print hOutput "else\n";
print hOutput "    echo \"Wrong installation folder...Please move atlasviewer_install to Downloads and rerun setup from there\"\n";
print hOutput "    touch \$script_dir\.error\n";
print hOutput "    err=1;\n";
print hOutput "fi\n";
print hOutput "\n";

# If not running script from ~/Downloads/atlasviewer_install then copy current atlasviewer_install folder to ~/Downloads  
print hOutput "if [ \$err = 1 ]; then\n";
print hOutput "    if [ -d ~/Downloads/atlasviewer_install ]; then\n";
print hOutput "        echo ~/Downloads/atlasviewer_install exists .... Deleting ~/Downloads/atlasviewer_install\n";
print hOutput "        rm -rf ~/Downloads/atlasviewer_install;\n";
print hOutput "    else\n";
print hOutput "        echo ~/Downloads/atlasviewer_install does not exist ... will create it\n";
print hOutput "    fi\n";
print hOutput "    echo cp -r \$script_dir ~/Downloads/atlasviewer_install;\n";
print hOutput "    cp -r \$script_dir ~/Downloads/atlasviewer_install;\n";
print hOutput "fi\n";
...
while(my $line = <hInput>)  
{
    ...
    {
    	$linenew = "exe_dir=~/Downloads/atlasviewer_install\n";
    } 
