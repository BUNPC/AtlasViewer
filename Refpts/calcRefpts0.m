function [eeg_curves, err] = calcRefpts0(surf, Nz, Iz, RPA, LPA, Czi, stepsizes)
...
[eeg_curves.LPACzRPA.pos, eeg_curves.LPACzRPA.len] = calcRefptsAlongCurve(curve_pts_LPACzRPA, len_LPACzRPA, eeg_curves.LPACzRPA.labels, stepsize3, 'LPA-Cz-RPA');
waitbar(iCurve/nCurves, hwait); iCurve=iCurve+1;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
T9 = eeg_curves.LPACzRPA.pos{1};
T10 = eeg_curves.LPACzRPA.pos{end};
...
T9h  = eeg_curves.LPACzRPA.pos{2};
T10h = eeg_curves.LPACzRPA.pos{end-1};
...
T7  = eeg_curves.LPACzRPA.pos{3};
T8  = eeg_curves.LPACzRPA.pos{end-2};
