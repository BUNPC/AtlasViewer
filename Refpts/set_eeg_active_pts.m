function [refpts, labels_missing_str] = set_eeg_active_pts(refpts, mode, showprogress)

% 
%  Function: 
%      
%         refpts = set_eeg_active_pts(refpts, mode)
%
%  Description:
%
...
switch(refpts.eeg_system.selected)
    ...
    case 'selected_curves_10_20'
        l = extract_eeg_labels(refpts.eeg_system.curves);
        eeg_system_labels = l.labels_10_20;
    case 'selected_curves_10_10'
        l = extract_eeg_labels(refpts.eeg_system.curves);
        eeg_system_labels = l.labels_10_10;
    case 'selected_curves_10_5'
        l = extract_eeg_labels(refpts.eeg_system.curves);
        eeg_system_labels = l.labels_10_5;
end
